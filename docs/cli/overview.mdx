...
- **OpenAI-Compatible APIs**: Native support for Ollama, LM Studio, and custom endpoints
...
- **Settings**: Configuration interface for AI models, API keys, URLs, and UI preferences
- **Local AI Support**: Easy configuration for local models via environment variables
...
- Settings.tsx for configuration with API URL support
